...
if (pagename() === "CHANNEL 1"){
  $(".youmax").youmax({
                ...
                channelLink:"https://www.youtube.com/user/nikkiajoy",
...
if (pagename() === "CHANNEL 2"){
  $(".youmax").youmax({
                apiKey:"AIzaSyAlhAqP5RS7Gxwg_0r_rh9jOv_5WfaJgXw",
                	//apiKey:"AIzaSyC3lXNm8-OC5y3uFLUQjPkTCTP6qR7Bv0s", //CASTERO APPS LEARN KUNGFU [ NEW ]
                channelLink:"https://www.youtube.com/channel/UCXoY0ZeHZBe0p-ByCiYP_XQ",
	  	playlistLink:"https://www.youtube.com/?listType=user_uploads&list=shemmati10yt",
...
if (pagename() === "CHANNEL 3"){
  $(".youmax").youmax({
                apiKey:"AIzaSyAlhAqP5RS7Gxwg_0r_rh9jOv_5WfaJgXw",
                	//apiKey:"AIzaSyC3lXNm8-OC5y3uFLUQjPkTCTP6qR7Bv0s", //CASTERO APPS LEARN KUNGFU [ NEW ]
                channelLink:"https://www.youtube.com/user/theepatrickstarrr",
...
if (pagename() === "CHANNEL 4"){
  $(".youmax").youmax({
                apiKey:"AIzaSyAlhAqP5RS7Gxwg_0r_rh9jOv_5WfaJgXw",
                	//apiKey:"AIzaSyC3lXNm8-OC5y3uFLUQjPkTCTP6qR7Bv0s", //CASTERO APPS LEARN KUNGFU [ NEW ]
                channelLink:"https://www.youtube.com/user/BellesaAfrica",
                playlistLink:"https://www.youtube.com/?listType=user_uploads&list=purpledriving",
...
if (pagename() === "CHANNEL 5"){
  $(".youmax").youmax({
                apiKey:"AIzaSyAlhAqP5RS7Gxwg_0r_rh9jOv_5WfaJgXw",
                	//apiKey:"AIzaSyC3lXNm8-OC5y3uFLUQjPkTCTP6qR7Bv0s", //CASTERO APPS LEARN KUNGFU [ NEW ]
                channelLink:"https://www.youtube.com/user/YofiCosmetics",
...
if (pagename() === "CHANNEL 6"){
  $(".youmax").youmax({
                ...
                channelLink:"https://www.youtube.com/user/karmen2260",
	            	playlistLink:"https://www.youtube.com/?listType=user_uploads&list=purpledriving",
